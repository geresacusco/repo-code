...
eefHeader <- function(id="equality") {
  ...
  div(class="w3-display-container eef-header-box eef-clearfix",#related styles in EEFextra.css for class: .eef-header-box (invisible box containing the header)
      ...
      div(class="eef-header-menu",
          ...
          a(id=ns("menu2"),href="javascript:void(0)","Repositorio",class="eef-page-links2 eef-page-links25"),#class "eef eef-XXXX" shows/hides components when on/not on page XXXX 
          a(id=ns("menu3"),href="https://diresacusco2020.maps.arcgis.com/apps/opsdashboard/index.html#/a28819de66a14c059498b7e02f08a781","Sala Situacional",class="eef-page-links2 eef-page-links25"),
          a(id=ns("menu4"),href="https://geresacusco.shinyapps.io/DASHBOARD_COVID-19_CUSCO/","Analisis de la Pandemia",class="eef-page-links2 eef-page-links15"),
          a(id=ns("menu5"),href="javascript:void(0)","Guia de uso",class="eef-page-links2 eef-page-links15")
      )
  )
}
