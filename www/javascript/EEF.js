...
$(document).ready(function(){
  ...
  $('a[data-value=\"equality\"]').click(function(){
    ...
    $('.eef:not(.eef-main)').show();
    $('.eef-main').show();
    $('.eef-section-header-expand').show();
    $('.eef-section-content,.eef-section-header-collapse').show;
  ...
  $('.eef-grid-square,.eef-grid-summ,.eef-mobile-grid.sub').click(function(){
    ...
    $('.eef-section-content,.eef-section-header-collapse').show(); //hide content that's in drop down toggle boxes
